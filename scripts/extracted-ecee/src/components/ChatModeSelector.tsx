...
const MODE_LABEL_KEY: Record<
  ChatInteractionMode,
  "chatModeNormal" | "chatModeGather" | "chatModeAgent"
> = {
  normal: "chatModeNormal",
  gather: "chatModeGather",
  agent: "chatModeAgent",
};

const MODE_HINT_KEY: Record<
  ChatInteractionMode,
  "chatModeNormalHint" | "chatModeGatherHint" | "chatModeAgentHint"
> = {
  normal: "chatModeNormalHint",
  gather: "chatModeGatherHint",
      ...
      ? createPortal(
          ...
          >
            {CHAT_INTERACTION_MODES.map((item) => {
              ...
              const itemDisabled = needsWorkspace && !hasWorkspace;
                ...
                <button
                  ...
                  title={
                    itemDisabled
                      ...
                      : t(lang, MODE_HINT_KEY[item])
                  }
                  className={`model-selector__option${isActive ? " model-selector__option--active" : ""}${itemDisabled ? " model-selector__option--busy" : ""}`}
                  onClick={() => {
